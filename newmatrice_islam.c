...
int main() {
    ...
    scanf("%d", &m1);
    printf("donner le nombre de lignes de la matrice C : ");
    scanf("%d", &n2);
    printf("donner le nombre de colonnes de la matrice C : ");
    scanf("%d", &m2);

    // Saisir les valeurs de la matrice B
    printf("donner les valeurs de la matrice B :\n");
    for (int i = 0; i < n1; i++) {
        for (int j = 0; j < m1; j++) {
            printf("B[%d][%d] : ", i, j);
            scanf("%d", &B[i][j]);
    ...
    printf("donner les valeurs de la matrice C :\n");
    for (int i = 0; i < n2; i++) {
        for (int j = 0; j < m2; j++) {
            printf("C[%d][%d] : ", i, j);
            scanf("%d", &C[i][j]);
